...
class Controller():
    ...
    def stream(self):
        ...
        while True:
            ...
            mainImage = take_pic(self.mainCamera)
            sideImage = take_pic(self.sideCamera)
            display_pic(self.viewIdle.mainCameraLabel,mainImage)
            display_pic(self.viewIdle.sideCameraLabel,sideImage)
            display_pic(self.viewRegister.sideCameraLabel,sideImage)
