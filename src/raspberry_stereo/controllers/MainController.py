...
class MainController():
    ...
    def draw_registration(self):
        ...
        self.viewRegister.zeroButton.place(x=270, y=130)
        self.viewRegister.oneButton.place(x=320, y=130)
        self.viewRegister.twoButton.place(x=370, y=130)
        self.viewRegister.threeButton.place(x=420, y=130)
        self.viewRegister.fourButton.place(x=470, y=130)
        self.viewRegister.fiveButton.place(x=520, y=130)
        self.viewRegister.sixButton.place(x=570, y=130)
        self.viewRegister.sevenButton.place(x=620, y=130)
        self.viewRegister.eightButton.place(x=670, y=130)
